...
#+BEGIN_EXAMPLE
 (Failing Passing) ← ⎕UT.run File.dyalog
#+END_EXAMPLE
...
#+BEGIN_EXAMPLE
 ...
 ⍋ 152 PASSED  
 ⍒ 2   FAILED 
 (Failing Passing) ← ⎕UT File.dyalog
#+END_EXAMPLE
...
#+BEGIN_EXAMPLE
 ...
 (Failing Skipped Passing) ← ⎕UT.run File.dyalog 
#+END_EXAMPLE
...
#+BEGIN_EXAMPLE
 ...
 ⋄ 0  SKIPPED
 ⍒ 0  FAILED 
 (Failing Skipped Passing) ← ⎕UT Test_GROUP File.dyalog
#+END_EXAMPLE
...
#+BEGIN_EXAMPLE
 ...
 --------------------------
  ...
  ⋄ 0  SKIPPED
  ⍒ 1  FAILED
 (Failing Skipped Passing) ← ⎕UT.run Test_SUITE File.dyalog
#+END_EXAMPLE
